...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-green-200">
      {/* Header Corporativo */}
      <header className="bg-slate-900 text-white p-4 sticky top-0 z-50 border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl md:text-2xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-yellow-200">
                Simulado Petrobras
            </span>
          </div>
      ...
      <div className="relative overflow-hidden bg-slate-50 pt-16 pb-24 md:pt-24 md:pb-32 border-b border-slate-200">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16 lg:gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-100/50 border border-green-200 text-green-800 text-xs font-black tracking-widest uppercase mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              ...
              <div className="flex items-center gap-3 font-bold text-slate-700 bg-white p-4 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.04)] border border-slate-100">
                <div className="bg-green-100 p-2 rounded-lg text-green-600"><BarChart3 size={20} /></div>
          ...
          {/* Caixa Suspensa de Autenticação na Lateral */}
          <div className="lg:col-span-5 relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-green-600 to-yellow-500 rounded-[2rem] blur opacity-20 animate-pulse"></div>
              ...
              <form onSubmit={handleAuth} className="space-y-5">
                <div>
                  ...
                  <input 
                    ...
                    required
                    className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-green-100 focus:border-green-500 focus:bg-white outline-none transition-all font-medium text-slate-800"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                ...
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-green-200 rounded-full flex items-center justify-center font-bold text-green-800">CJ</div>
                    <div>
                        <div className="font-bold text-slate-900 text-sm">Carlos Junior</div>
                        <div className="text-xs text-slate-500 font-medium">Candidato à Engenharia</div>
                    </div>
                </div>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 transform md:-translate-y-4 shadow-xl border-green-100 ring-4 ring-green-50">
                <div className="flex gap-1 mb-4 text-amber-400"><Target size={20} fill="currentColor" /><Target size={20} fill="currentColor" /><Target size={20} fill="currentColor" /></div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-500 font-medium">Candidata à Geociências</div>
                    </div>
                </div>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                ...
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-yellow-200 rounded-full flex items-center justify-center font-bold text-yellow-800">RD</div>
                    <div>
                        <div className="font-bold text-slate-900 text-sm">Rafael Dantas</div>
                        <div className="text-xs text-slate-500 font-medium">Candidato à Administração</div>
                    </div>
                </div>
            </div>
          </div>
      ...
      <footer className="bg-slate-950 text-slate-500 py-12 text-center text-sm font-medium">
        <p>© {new Date().getFullYear()} Simulado Petrobras 2026. {t('lp_footer_disclaimer')}</p>
        <div className="mt-4 flex justify-center gap-6 text-slate-600">
          <button onClick={() => setShowSupport(true)} className="hover:text-green-400 flex items-center gap-2">
